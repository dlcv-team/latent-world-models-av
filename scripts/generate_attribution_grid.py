...
Composes per-encoder attribution overlay PNGs into a 5×4 grid figure.
...
def main():
    ...
    parser.add_argument(
        ...
        help="Directory containing {encoder}_{scenario}_{index:02d}.png files (default: outputs/attribution)",
    )

    parser.add_argument(
        "--output",
        type=Path,
        default=Path("outputs/attribution/attribution_grid.pdf"),
        help="Output PDF file path (default: outputs/attribution/attribution_grid.pdf)",
    )
